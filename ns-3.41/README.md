...
Additionally, the scratch folder's .gitignore file has been removed since we will be building our simulation scripts there and want to maintain history.

For the 3rd Year Project(s) we will be adding OSPF into the model and helper folders under ns-3.41/src/internet

## Old READ.ME continues ##
